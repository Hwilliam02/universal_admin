...
import { createSuperAdmin, getTenentUsers, getCompanyUsers, updateUserStatus, undeleteUser, getGlobalUsers, updateGlobalUserStatus  } from '../controllers/userController.js';
import auth from '../middleware/auth.js';


router.post('/create-super-admin', createSuperAdmin);
router.get('/tenents', auth, getTenentUsers);
