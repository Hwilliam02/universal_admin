...
const getTenentUsers = async (req, res) => {
  try {
...
export { createSuperAdmin, getTenentUsers, getCompanyUsers, updateUserStatus, undeleteUser, getGlobalUsers, updateGlobalUserStatus };